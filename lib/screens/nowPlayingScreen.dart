...
//                             setState(() {
//                               if (isChecking) {
//                                 removeFromFav(int.parse(playing.audio.audio.metas.id!));
//                               } else {
//                                 addToFavorites(int.parse(playing.audio.audio.metas.id!));
//                               }
//                             });
//                           },
//                           child: Container(
...
//                           IconButton(
//                             onPressed: () {
//                               bool checking = favoriteChecking(int.parse(playing.audio.audio.metas.id!));
//                               setState(() {
//                                 if (checking) {
//                                   removeFromFav(int.parse(playing.audio.audio.metas.id!));
//                                 } else {
...
//                             },
//                             icon: Icon(
//                               isChecking ? Icons.favorite : Icons.favorite_border,
//                               color: isChecking ? Colors.red : Colors.white,
//                             ),
//                           )
//                         ],
//                       ),
...
//                               total: duration,
//                               timeLabelPadding: 15,
//                               onSeek: (duration) => assetsAudioPlayer.seek(duration),
